...
{
    {
        {D_DrawTitle1, "TITLEPIC11"},
        {D_DrawTitle1, "TITLEPIC11"},
        {D_DrawTitle2, "TITLEPIC11"},
        {D_DrawTitle1, "TITLEPIC11"},
    },
...
static void D_DoomMainSetup(void)
{
    ...
    // Register lumps missing from the WAD as virtual lumps.
    // TITLEPIC is absent in stripped WADs; supply our own image.
    W_AddVirtualLump("TITLEPIC11", titlepic_patch_data, (int)titlepic_patch_size);

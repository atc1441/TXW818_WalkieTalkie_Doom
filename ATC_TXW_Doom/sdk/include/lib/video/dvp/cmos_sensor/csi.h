...
#ifndef DEV_SENSOR_GCcustom
#define DEV_SENSOR_GCcustom  				(0||CMOS_AUTO_LOAD)
#endif
...
extern const _Sensor_Ident_ gccustom_init;
extern SENSOR_OP_SECTION const _Sensor_Adpt_ gccustom_cmd;
#endif
